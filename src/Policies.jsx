...
const Policies = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="policies-hero-section">
        <div className="policies-hero-container">
      ...
      <section className="policies-main-section">
        <div className="policies-container">
          ...
          <div className="policy-contact-section">
            ...
            <p>
              ...
              please don't hesitate to contact us. We're committed to transparency and protecting 
              your privacy.
            </p>
            <div className="policy-contact-info">
              <p><strong>Email:</strong> <a href="mailto:viplc.management@gmail.com">viplc.management@gmail.com</a></p>
              <p><strong>Phone:</strong> <a href="tel:(972) 513-0224">(972) 513-0224</a></p>
              <p><strong>Address:</strong> 3219 Vinson Ct, Irving, TX 75060</p>
            </div>
          </div>
